@extends('layout.app', ["current" => "fotos"])
            ...
            <div class="col-md-4">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-group">
                        ...
                        <a type="button" class="btn btn-sm btn-outline-secondary" href="/fotos/baixar/{{$post->id}}">Download</a>
                        <form method="get" action="/fotos/{{$post->id}}">
                        @csrf
